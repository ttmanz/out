...
export const createHappening = (userId, { title, venue, happening_at, description, photo_url = null, video_url = null, link_url = null, link_title = null, link_image = null, link_domain = null }) =>
  supabase
    .from('happenings')
    .insert({ user_id: userId, title, venue, happening_at, description, photo_url, video_url, link_url, link_title, link_image, link_domain });
