...
export const getProfile = (userId) =>
  supabase
    .from('profiles')
    .select('id, full_name, visibility, allow_friend_requests, status, is_admin, photo_url, dob, gender, city, bio, interests, phone, instagram, profile_completed, subscription_plan, subscription_expires_at')
    .eq('id', userId)
    .single();
